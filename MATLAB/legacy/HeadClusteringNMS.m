function [cellHeadCluster, listSoleHeadCluster, headIdxSet] = HeadClusteringNMS(...
    headIdxSet, listCParts, model, clusterOverlapRatio, partOverlapRatio)
% <description>
% - clustering heads with connectivity by parts overlap
% <input>
% - headIdxSet: set of head indices after NMS
